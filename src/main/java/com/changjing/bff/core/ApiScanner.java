...
public class ApiScanner {
     ...
     *
     * @param jarFilePath JAR文件的路径，不能为空或空字符串
     * @param basePackage 基础包名，用于确定扫描的包范围，不能为空或空字符串
     *
     * @throws IllegalArgumentException 如果jarFilePath或basePackage为空或空字符串，则抛出此异常
     * @throws RuntimeException 如果读取JAR文件失败，则抛出此异常
     */
    public void scanExternalJarApis(String jarFilePath, String basePackage) {
        // 检查输入参数的有效性
